...
with sudo docker run -e RANSAMPLE=y -e NUMWARCS=120 -e NUMRECORDS=200 -e PYTHONFILETORUN=./sentiment_long_optim.py sentiment_long_boot 
...
you can pass -e RANSAMPLE=y to randomly sample the crawls, or -e RANSAMPLE=n to take all the most recent crawls.
